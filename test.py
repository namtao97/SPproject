...
log_pxuong_threshole = -23000

screen = pygame.display.set_mode(scr_size)
clock = pygame.time.Clock()
pygame.display.set_caption("T-Rex Rush with voice control")
...
class Ptera(pygame.sprite.Sprite):
    def __init__(self,speed=5,sizex=-1,sizey=-1):
        ...
        self.ptera_height = [max_height_ptera*0.82, max_height_ptera*0.75, max_height_ptera*0.60]
...
def introscreen():
    ...
    callout_rect.top = height*0.4 + 70
    ...
    logo_rect.centery = height*0.6 + 70
...
def sp():
    ...
    with open("hmm/model_xuong.pkl", "rb") as file2:
    ...
    while True:
        ...
        if plen > pxuong:
            ...
            if log_pxuong > log_pxuong_threshole:
                if not lock:
                    lock = True
                    action = XUONG
                    lock = False
